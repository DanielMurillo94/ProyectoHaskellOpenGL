...
main = do
    ...
    keyboardMouseCallback $= Just (teclado vposx vposy dispara posicionx posiciony enemigos randind)
    mainLoop
...
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 'a') Down _ _ = do
    vposx $= 0.05
    postRedisplay Nothing
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 'd') Down _ _ = do
    vposx $= -0.05
    postRedisplay Nothing
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 'w') Down _ _ = do
    vposy $= 0.05
    postRedisplay Nothing
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 's') Down _ _ = do
    vposy $= -0.05
    postRedisplay Nothing
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 'a') Up _ _ = do
    vposx $= 0
    postRedisplay Nothing
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 'd') Up _ _ = do
    vposx $= 0
    postRedisplay Nothing
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 'w') Up _ _ = do
    vposy $= 0
    postRedisplay Nothing
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 's') Up _ _ = do
    vposy $= 0
    postRedisplay Nothing
teclado vposx vposy dispara posicionx posiciony enemigos randind(Char 'j') Down _ _ = do
    e <- get dispara
    cb <- get enemigos
    x <- get posicionx
    y <- get posiciony
    ...
    enemigos $= insertCubo ranX ranY 5 0.05 cb
    postRedisplay Nothing
teclado _ _ _ _ _ _ _ _ _ _ _= return ()
